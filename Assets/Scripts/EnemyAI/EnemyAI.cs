...
namespace AIState
{
    public class EnemyAI : ICharacterAI
    {
        ...
        public EnemyAI(BaseEntity entity, EnemyType enemyType) : base(entity)
        {
            ...
            m_AttackRange = entity.m_AttrValue.NormalAttackRange;
            m_ChaseRange = (entity as Monster).GetMonsterValue().ChaseRange;
            JumpAttckRange = (entity as Monster).GetMonsterValue().JumpAttckRange;
        }
        ...
        public override void JumpAttack(BaseEntity Target, System.Action CallBack)
        {
            ...
            jumpAction.Attack(Target, monster.GetMonsterValue().JumpHeight, monster.GetMonsterValue().JumpTime, monster.PrepareJumpTime(Target), CallBack);
        }
        ...
        public override void Restats(BaseEntity HitFrom)
        {
            MoveDir backDir = HitFrom.transform.position.x - GetPosition().x >= 0 ? MoveDir.Left : MoveDir.Right;
            (m_Entity as Monster).Restats(backDir);
        }
    }
